...
@section('page-header')
    ...
    <div class="button-box col-md-5">
		<button class="btn btn-primary" type="button" onclick="document.getElementById('extra-form').submit();">
			<i class="fa fa-save"></i> Update extra
		</button>
    </div>
@endsection
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('backend.extras.update', $extra) }}" enctype="multipart/form-data" method="POST" id="extra-form">
            @csrf
            @method('PUT')
                ...
                <div class="col">
                    ...
                    <div class="tab-content px-1 pt-1">
                        <div role="tabpanel" class="tab-pane active" id="tab0" aria-expanded="true" aria-labelledby="base-tab0">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.extras.edit.form_parts.general')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.extras.edit.form_parts.seo')
                                </div>
                            </div>
                        </div>
                    </div>
