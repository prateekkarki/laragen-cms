...
@section('page-header')
    <div class="title-box col-md-7">
        <div class="section-header-back">
            <a href="{{ route('backend.categories.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>
            Category Management
        </h1>
    ...
    <div class="button-box col-md-5">
		<button class="btn btn-primary" type="button" onclick="document.getElementById('category-form').submit();">
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('backend.categories.update', $category) }}" enctype="multipart/form-data" method="POST" id="category-form">
            @csrf
            @method('PUT')
                ...
                <div class="col">
                    ...
                    <div class="tab-content px-1 pt-1">
                        <div role="tabpanel" class="tab-pane active" id="tab0" aria-expanded="true" aria-labelledby="base-tab0">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.categories.edit.form_parts.general')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.categories.edit.form_parts.seo')
                                </div>
                            </div>
                        </div>
                    </div>
