...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('backend.categories.store') }}" enctype="multipart/form-data" method="POST" id="category-form">
            @csrf
                ...
                <div class="col">
                    ...
                    <div class="tab-content px-1 pt-1">
                        <div role="tabpanel" class="tab-pane active" id="tab0" aria-expanded="true" aria-labelledby="base-tab0">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.categories.create.form_parts.general')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.categories.create.form_parts.seo')
                                </div>
                            </div>
                        </div>
                    </div>
