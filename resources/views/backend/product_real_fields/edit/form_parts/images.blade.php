...
<script type="text/javascript">
    dropzoneupload('{{ route('backend.uploader') }}', 'filename', '{!! $product_real_field->id ?? "''" !!}','product_real_field', ".png,.jpg,.gif,.bmp,.jpeg", false, '{!! json_encode([['filename' => $product_real_field->filename, 'size'=>null ]]) !!}');
</script>
@endpush
