...
@section('page-header')
    ...
    <div class="button-box col-md-5">
		<button class="btn btn-primary" type="button" onclick="document.getElementById('product_real_field-form').submit();">
			<i class="fa fa-save"></i> Update product_real_field
		</button>
    </div>
@endsection
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('backend.product_real_fields.update', $product_real_field) }}" enctype="multipart/form-data" method="POST" id="product_real_field-form">
            @csrf
            @method('PUT')
                ...
                <div class="col">
                    ...
                    <div class="tab-content px-1 pt-1">
                        <div role="tabpanel" class="tab-pane active" id="tab0" aria-expanded="true" aria-labelledby="base-tab0">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.product_real_fields.edit.form_parts.general')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.product_real_fields.edit.form_parts.relations')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab2" aria-expanded="true" aria-labelledby="base-tab2">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.product_real_fields.edit.form_parts.images')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab3" aria-expanded="true" aria-labelledby="base-tab3">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.product_real_fields.edit.form_parts.seo')
                                </div>
                            </div>
                        </div>
                    </div>
