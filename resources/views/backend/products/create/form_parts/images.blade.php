...
<script type="text/javascript">
    dropzoneupload('{{ route('backend.uploader') }}', 'image', '{!! $product->id ?? "''" !!}','product', ".png,.jpg,.gif,.bmp,.jpeg", false)
</script>
@endpush
...
@push('after-scripts')
<script type="text/javascript">
    dropzoneupload('{{ route('backend.gallery.uploader') }}', 'real_field', '','product', ".png,.jpg,.gif,.bmp,.jpeg", true)
</script>
@endpush
