...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('backend.products.store') }}" enctype="multipart/form-data" method="POST" id="product-form">
            @csrf
                ...
                <div class="col">
                    ...
                    <div class="tab-content px-1 pt-1">
                        <div role="tabpanel" class="tab-pane active" id="tab0" aria-expanded="true" aria-labelledby="base-tab0">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.products.create.form_parts.general')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.products.create.form_parts.relations')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab2" aria-expanded="true" aria-labelledby="base-tab2">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.products.create.form_parts.images')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab3" aria-expanded="true" aria-labelledby="base-tab3">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.products.create.form_parts.extrasauces')
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane " id="tab4" aria-expanded="true" aria-labelledby="base-tab4">
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    @include('backend.products.create.form_parts.seo')
                                </div>
                            </div>
                        </div>
                    </div>
